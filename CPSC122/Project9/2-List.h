...
Description: Program illustrates my understanding of a linked list
Note: I utilize Dr.DePalma's test to show that I was capable of getting
      PutItemH(), Print(), and DeleteItemH() to work 
*/
